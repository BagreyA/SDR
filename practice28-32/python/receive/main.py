...
plt.legend()
plt.grid(True)
plt.savefig(os.path.join(save_dir, 'original_IQ.png'))
plt.close()
...
plt.grid(True)
plt.savefig(os.path.join(save_dir, 'constellation_before.png'))
plt.close()
...
plt.legend()
plt.grid(True)
plt.savefig(os.path.join(save_dir, 'filtered_IQ.png'))
plt.close()
...
plt.grid(True)
plt.savefig(os.path.join(save_dir, 'constellation_after_filter.png'))
plt.close()
...
plt.legend()
plt.grid(True)
plt.savefig(os.path.join(save_dir, 'sync_errors.png'))
plt.close()
...
plt.legend()
plt.grid(True)
plt.savefig(os.path.join(save_dir, 'tau_shift.png'))
plt.close()

combined_sync = np.array(sync_I) + 1j * np.array(sync_Q)
plot_eye_diagram(combined_sync, 1, len(sync_I), save_path=os.path.join(save_dir, 'eye_diagram.png'))
